            ...
            UserRole::RoomAdmin => {
                ...
                Some(match kind {
                    RoomKind::Room { .. } | RoomKind::Dm { .. } => {
                        ...
                        r.inherit_capabilities(&Self::roles(kind, UserRole::Member)?)
                            .with_capabilities([
                                StdCapability::CanAcceptKnock,
